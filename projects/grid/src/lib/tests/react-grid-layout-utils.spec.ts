...
describe('moveElement', () => {
    ...
    it('Moves elements out of the way without causing panel jumps when compaction is vertical', () => {
        ...
        expect(
            ...
            objectContaining({x: 0, y: 1, w: 1, h: 10, i: 'A'}),
            objectContaining({x: 0, y: 0, w: 1, h: 1, i: 'B'}),
            objectContaining({x: 0, y: 11, w: 1, h: 1, i: 'C'})
        ]);
    });
    ...
    it('Calculates the correct collision when moving large object far', () => {
        ...
        expect(
            ...
            objectContaining({x: 0, y: 2, w: 1, h: 10, i: 'A'}),
            objectContaining({x: 0, y: 1, w: 1, h: 1, i: 'B'}),
            objectContaining({x: 0, y: 12, w: 1, h: 1, i: 'C'})
        ]);
    });
    ...
    it('Moves one element to another should cause moving down panels, vert compact, example 1', () => {
        ...
        expect(
            ...
            objectContaining({x: 0, y: 1, w: 2, h: 1, i: 'A'}),
            objectContaining({x: 1, y: 0, w: 2, h: 1, i: 'B'}),
            objectContaining({x: 0, y: 2, w: 1, h: 1, i: 'C'}),
            objectContaining({x: 1, y: 2, w: 3, h: 1, i: 'D'})
        ]);
    });
    ...
    it('Moves one element to another should cause moving down panels, vert compact, example 2', () => {
        ...
        expect(
            ...
            objectContaining({x: 0, y: 2, w: 2, h: 1, i: 'A'}),
            objectContaining({x: 0, y: 3, w: 1, h: 1, i: 'B'}),
            objectContaining({x: 1, y: 0, w: 1, h: 2, i: 'C'})
        ]);
    });
});
